...
{#if browser}
	<div class="size-full max-w-svw wx-theme">
...
.wx-theme {
  ...
  --wx-box-shadow-strong: 0px 4px 48px var(--color-stone-600),
  0px 4px 8px var(--color-black);
  ...
  --wx-button-box-shadow: -2px -2px 4px 0px var(--color-white) inset,	2px 2px 3px 1px var(--color-black) inset;
  --wx-button-primary-box-shadow: -2px -2px 4px 0px var(--color-white) inset, 2px 2px 3px 1px var(--color-black) inset;
  /* end button */

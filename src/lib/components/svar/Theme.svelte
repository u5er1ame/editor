...
<style>
	@media not print {
		.wx-theme {
			...
			--wx-input-border-radius: var(--wx-input-border-radius);
			...
			--wx-slider-thumb-border-color-disabled: 1px solid var(--color-muted-foreground);
			--wx-slider-thumb-background: var(--color-foreground);
			--wx-slider-thumb-background-disabled: var(--wx-color-disabled);
			...
			--wx-switch-thumb-border-color-disabled: 1px solid var(--color-muted-foreground);
	...
	/* Print styles - override CSS variables for black and white */
	@media print {
		.wx-theme {
			/* Override color variables for black and white */
			--wx-color-font: #000000;
			--wx-color-font-alt: #333333;
			--wx-color-font-disabled: #666666;
			--wx-color-link: #000000;

			--wx-background: #ffffff;
			--wx-background-alt: #f0f0f0;
			--wx-background-hover: #e0e0e0;

			--wx-border-color: #cccccc;
			--wx-border: 1px solid #cccccc;

			--wx-color-primary: #000000;
			--wx-color-secondary: #f0f0f0;
			--wx-color-disabled: #cccccc;

			/* Grid specific variables */
			--wx-table-header-background: #f0f0f0;
			--wx-table-header-border: 1px solid #cccccc;
			--wx-table-header-cell-border: 1px solid #cccccc;
			--wx-table-cell-border: 1px solid #cccccc;
			--wx-table-border: 1px solid #cccccc;

			/* Input and button colors */
			--wx-input-background: #ffffff;
			--wx-input-border: 1px solid #cccccc;
			--wx-button-background: #f0f0f0;
			--wx-button-font-color: #000000;
